...
public class HomeApiController {
    ...
    public HomeDto home(@CurrentAccount Account account) {
        ...
        HomeComponentDto<List<BannerDto>> topBanner = new HomeComponentDto<>(
                ...
                List.of(
                        new BannerDto(1L, "혼자 방송 볼 때\n심심하다면?\n사바사!", "https://s3.amazonaws.com/thumbnail.airplane/img_main_01.png"),
                        new BannerDto(2L, "사이더들과\n오늘 밤\n달려요!", "https://s3.amazonaws.com/thumbnail.airplane/img_main_02.png"),
                        new BannerDto(3L, "구독 방송\n핫한 방송\n한번에!", "https://s3.amazonaws.com/thumbnail.airplane/img_main_03.png")));
